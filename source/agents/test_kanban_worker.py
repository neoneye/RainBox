...
def test_kanban_worker_in_agent_config():
    ...
    from agents.config import KANBAN_WORKER_UUID, agent_config
...
def worker_board(app_ctx):
    ...
    from agents.config import KANBAN_WORKER_UUID
...
def test_worker_done_routes_to_review_with_deliverable(worker_board):
    from agents.kanban_worker import KanbanWorkerReply
