...
- `main.py` — the launcher (`docs/superpowers/specs/2026-09-10-launcher-design.md`): stdlib-only, starts `core.py` and the enabled side services as siblings and supervises them.
